    ...
    return (
        <div>
            ...
            <p>
                ...
                Only by initiating contact with us via the <a href="/contact">contact page</a>, will your name and email address be made known to us and in which case will only be used for the purpose of replying to your message via email.
                Your name, email and message will be deleted after 30 days. You may also request for this information to be deleted immediately at any time.
            ...
            <p>
                This Privacy Policy is effective as of October 2020 and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.
                We reserve the right to update or change our Privacy Policy at any time and you should check this Privacy Policy periodically. Your continued use of the Service after we post any modifications to the Privacy Policy on this page will constitute your acknowledgment of the modifications and your consent to abide and be bound by the modified Privacy Policy.
            </p>

            <h2>Contact</h2>
            <p>
                If you have any questions about this Policy, please get in contact by <a href="/contact"> sending a message.</a>
            </p>
        </div>
    )
}
